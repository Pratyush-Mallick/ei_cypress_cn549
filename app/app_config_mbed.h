...
// Pin mappeing for LTC26x6 DAC using I2C
...
#define CY_I2C_SDA  	    D14
#define CY_I2C_SCL			D15

// Conversion over interrupt
#define CONV_MON		D2

/* Common pin mapping */
#define CY_UART_TX		CONSOLE_TX
#define	CY_UART_RX		CONSOLE_RX
#endif
...
#define AD77681_DEFAULT_SAMPLING_FREQ	32000//((AD77681_MCLK * 1000) / AD77681_ODR_CONV_SCALER)
